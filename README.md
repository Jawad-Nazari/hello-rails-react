...
**Greetings** Greeting App with Rails and React. Implement a connection between a Ruby on Rails back-end and React front-end and display a random greeting messages along with providing API endpoint.
...
Feel free to check the [issues page](https://github.com/Jawad-Nazari/hello-rails-react/issues).
